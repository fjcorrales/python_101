...
def procesamiento_excel(nombre):
    ...
    for fila in range (2, sheet.max_row + 1):  #el in range excluye el ultimo valor pasado como argumento, por eso el +1 y empezamos en 2 para ignorar los nombres de las columnas
    ...
    valores = Reference(sheet, min_row=2, max_row=sheet.max_row, min_col=4, max_col=4)  #establecemos el rango de valores que queremos que use en el grafico
